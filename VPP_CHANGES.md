...
|---|---|---|
| [45505](https://gerrit.fd.io/r/c/vpp/+/45505) | mlx5 DV TSO support and corrected DV TX completion/WQE accounting | Parent of the eMPW series. The UDP64 workload does not exercise TSO, so no result is attributed to TSO offload. |
